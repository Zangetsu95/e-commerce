                ...
                <li class="treeview {{ $prefix == '/category' ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ $route == 'all.subcategory' ? 'active' : '' }}"><a
                                href="{{ route('all.subcategory') }}"><i class="ti-more"></i>All SubCategory
                            </a>
                        </li>
                ...
                <li class="treeview {{ $prefix == '/product' ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ $route == 'manage-product' ? 'active' : '' }}"><a
                                href="{{ route('manage-product') }}"><i class="ti-more"></i>Manage
                                Products</a>
                        </li>
                ...
                <li class="treeview {{ $prefix == '/shipping' ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ $route == 'manage-division' ? 'active' : '' }}"><a
                                href="{{ route('manage-division') }}"><i class="ti-more"></i>Ship
                                Divisions</a>
                        </li>
            ...
            @if ($blog == true)
                <li class="treeview {{ $prefix == '/blog' ? 'active' : '' }}  ">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ $route == 'blog-list' ? 'active' : '' }}"><a
                                href="{{ route('blog-list') }}"><i class="ti-more"></i>All Post</a></li>
                        <li class="{{ $route == 'blog-add' ? 'active' : '' }}"><a
                                href="{{ route('blog-add') }}"><i class="ti-more"></i>Add post</a></li>
                    </ul>
                </li>
            @else
            @endif
                ...
                <li class="treeview {{ $prefix == '/settings' ? 'active' : '' }}  ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ $route == 'site-settings' ? 'active' : '' }}"><a
                                href="{{ route('site-settings') }}"><i class="ti-more"></i>Site Setting</a>
                        </li>
                ...
                <li class="treeview {{ $prefix == '/review' ? 'active' : '' }}  ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ $route == 'review-see' ? 'active' : '' }}"><a
                                href="{{ route('review-see') }}"><i class="ti-more"></i>See the review</a>
                        </li>
                ...
                <li class="treeview {{ $prefix == '/orders' ? 'active' : '' }}  ">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ $route == 'shipped-orders' ? 'active' : '' }}"><a
                                href="{{ route('shipped-orders') }}"><i class="ti-more"></i> Shipped
                                Orders</a>
                        </li>
                ...
                <li class="treeview {{ $prefix == '/admin/user/role' ? 'active' : '' }}  ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ $route == 'all-admin-user' ? 'active' : '' }}"><a
                                href="{{ route('all-admin-user') }}"><i class="ti-more"></i>All Admin User
                            </a>
                        </li>
