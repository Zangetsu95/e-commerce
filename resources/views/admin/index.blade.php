...
@section('admin')
    ...
    $month = date('F');
    $order_month = App\Models\Order::where('order_month', $month)->sum('amount');

    $year = date('Y');
    $order_year = App\Models\Order::where('order_year', $year)->sum('amount');
                ...
                <div class="col-xl-3 col-6">
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Sales of the day</p>
                ...
                <div class="col-xl-3 col-6">
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Sold of the Month</p>
                                <h3 class="text-white mb-0 font-weight-500">{{ $order_month }} <small
                                        class="text-success"><i class="fa fa-caret-up"></i>€</small></h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-6">
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Sales of the year </p>
                                <h3 class="text-white mb-0 font-weight-500">{{ $order_year }} <small
                                        class="text-success"><i class="fa fa-caret-up"></i>€</small></h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">{{ count($pending) }} <small
                                        class="text-danger"><i class="fa fa-caret-up"></i></small></h3>
                            </div>
                        </div>
                    </div>
                </div>
