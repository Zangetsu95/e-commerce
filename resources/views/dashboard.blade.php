                            ...
                            <div class="col-md-3">
                                ...
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="orders-tab"  href="{{ route('my-orders') }}"  aria-controls="orders" aria-selected="false"><i class="fi-rs-shopping-bag mr-10"></i>Orders</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="account-detail-tab" href="{{ route('user.profile') }}"  aria-controls="account-detail" aria-selected="true"><i class="fi-rs-user mr-10"></i>Account details</a>
                                        </li>
                                        <li class="nav-item" style="background: rgba(69, 54, 54, 0.142)">
                                                ...
                                                <form method="post" name="enq">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input required="" class="form-control" name="dname" type="phone" />
                                                        </div>
                                                        <div class="form-group col-md-12">
