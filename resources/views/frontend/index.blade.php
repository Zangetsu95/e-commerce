            ...
            <section class="home-slider position-relative mb-30">
                <div class="home-slide-cover">
                    <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                        ...
                        <div class="single-hero-slider rectangle single-animation-wrap" style="background-image: url({{ asset($slider->slider_img) }})">
                        ...
                        <section class="product-tabs section-padding position-relative">
                            <div class="section-title style-2">
                                ...
                                <ul class="nav nav-tabs links" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link inactive" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="tab-one" aria-selected="true">{{ $category->category_name_en }}</button>
                                    </li>
                                    @endforeach
                                        ...
                                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap mb-30">
                                                ...
                                                <div class="product-content-wrap">
                                                    ...
                                                    <h2><a href="shop-product-right.html">{{ $product->product_name_en }}</a></h2>
